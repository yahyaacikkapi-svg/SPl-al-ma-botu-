...
export const config = {
  ...
  // Varsayilanlar kisisel kullanimda maliyeti dusuk tutacak sekilde secildi.
  // Daha guclu (ve pahali) alternatifler icin .env.example'a bak.
  chatModel: process.env.OPENAI_MODEL || 'gpt-5.6-luna',
  ...
  maxHistoryMessages: intFromEnv('MAX_HISTORY_MESSAGES', 10),
